    ...
    <div class="columns is-desktop">
        <div class="column">
            ...
            <form method="post">
                <div class="button-bar code">
                    <button type="button" class="button is-success" id="pyRun"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M3 22v-20l18 10-18 10z" />
                        </svg></button>
                    <button type="button" class="button is-danger" id="pyStop"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M2 2h20v20h-20z" />
                        </svg></button>
                    <button type="button" class="button is-link" id="codeSave"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <a type="button" class="button is-warning" id="codeDownload" href="./download.php?fileid=<?= $fileid ?>">
        ...
        <div class="column">
            ...
            <div class="button-bar output">
                <button type="button" class="button is-danger" id="outputClear"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                        <path d="M5.662 23l-5.369-5.365c-.195-.195-.293-.45-.293-.707 0-.256.098-.512.293-.707l14.929-14.928c.195-.194.451-.293.707-.293.255 0 .512.099.707.293l7.071 7.073c.196.195.293.451.293.708 0 .256-.097.511-.293.707l-11.216 11.219h5.514v2h-12.343zm3.657-2l-5.486-5.486-1.419 1.414 4.076 4.072h2.829zm6.605-17.581l-10.677 10.68 5.658 5.659 10.676-10.682-5.657-5.657z" />
                    </svg></button>
                <button type="button" class="button is-link is-primary" id="trtAnimate" data-status="on"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <a type="button" class="button is-warning" id="trtDownload"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
<script>
    $(document).ready(function() {
        ...
        function saveFileAjax(code) {
            ...
            xmlhttp.send("action=write&userid=<?php echo $fileid; ?>&data=" + encodeURIComponent(code));
        }
        ...
        function readDataAjax() {
            ...
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    let code = xmlhttp.responseText != '' ? xmlhttp.responseText : '';
                    toastr.success('Code loaded successfully!');
                    pb.getEditor().setValue(code);
                }
            }

            xmlhttp.open("POST", 'save.php', true);
            xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xmlhttp.send("action=read&userid=<?php echo $fileid; ?>");
        }
    });
</script>
